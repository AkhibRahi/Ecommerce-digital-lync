...
function Admin(props) {
    ...
    const startEdit = (product) => {
        // Populate the edit form with the data of the selected product
        // setProduct({ ...product });
    ...
    const cancelEdit = () => {
        // Clear the form and cancel the edit mode
        setProduct({
            productId: '',
            name: '',
            price: '',
    ...
    const saveEdit = () => {
        // Send a request to update the product on the server
        props.editRequest(API.updateProduct + "/" + editingProductId, product)
            .then(response => {
                // Handle the edit success
                cancelEdit();
                getProductsList();
            })
            .catch(error => {
